...
export default function Card({ title, platform, starttime, Link }) {   
    ...
    return (
        <div className="bg-neutral-800 rounded-2xl shadow-lg p-5 max-w-sm w-full flex flex-col items-center text-white transition-transform hover:scale-[1.02] min-h-[450px]">
